        ...
        <div>
            <div style={{
                ...
                <svg height="100" width="300">
                    ...
                    {props.side === 'vertical' ?
                        <>
                            <polygon points="177,50 167,60 177,35 187,60" style={{ fill: 'white', stroke: 'black', strokeWidth: 1 }} />
                            <line x1="177" y1="50" x2="177" y2="60" style={{ stroke: 'black', strokeWidth: 2 }} />
                            <path d="M 177 60 Q 177 80, 197 80" stroke="black" strokeWidth="2" fill="transparent" />
                            <line x1="197" y1="80" x2="260" y2="80" style={{ stroke: 'black', strokeWidth: 2 }} />
                            <polygon points="245,80 252,73 272,73 262,80 272,87 252,87" style={{ fill: props.color, stroke: 'black', strokeWidth: 1 }} />
                        </>
                        :
                        <>
